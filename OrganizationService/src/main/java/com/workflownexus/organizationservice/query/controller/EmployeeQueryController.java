...
public class EmployeeQueryController {
    ...
    public ResponseEntity<List<EmployeeResponse>> getDepartmentEmployee(@RequestParam(name = "departmentId") String departmentId){
    ...
    public ResponseEntity<List<EmployeeResponse>> getTeamEmployee(@RequestParam(name = "teamId") String teamId){
    ...
    public ResponseEntity<List<EmployeeResponse>> getSubTeamEmployee(@RequestParam(name = "subTeamId") String subTeamId){
